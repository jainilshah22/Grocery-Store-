...
import com.example.project1.adapters.NavCategoryDetailedAdapter;
import com.example.project1.models.MyCartModel;
import com.example.project1.models.NavCategoryDetailedModel;
...
public class NavCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(type!=null && type.equalsIgnoreCase("drink")){
            db.collection("NacCategoryDetailed").whereEqualTo("type","drink").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                @Override
